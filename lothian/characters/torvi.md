...
**Level ½** (1st-level retainer, half power) · Craft 1 · HP **2** (1d3) · Loyalty **7**

Half power ([Burners Muster](https://paulabrams.github.io/burners/burners-muster.html)): Approach rolls `2d6 + ⌊Craft/2⌋` (= +0); Fuel **level die ⌊1/2⌋ → min 1**. Puts herself first.

## Initiative pool (round 1)

Kit pool: level **1** (½-power floor) + spear **2** ≈ **3** (or dagger **1** = **2** if she swaps). Session 5 fiat was flat 5 while that ruling ran.
...
Outfitted from **Egil's purse** (Session 5 table):
...
She asked for leather, spear, and a kettle hat; Egil handed her a bag and she bought pretty.

## Look

Gottsburg quay lass — thin fingers, soft shoes, flat deadpan. Catch was thin; Stein had no more day-hire. Saw Egil's drum and said, *"Okay. Half-share. I open boxes. I do not do goat yoga."* Not sworn to Egil (that's Ylva); hired Craft.
...
See [Experience](../experience.md) — joins at **0**.
